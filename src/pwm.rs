...
//     pub fn pwm(&self, user_gpio: u32, dutycycle: u32) -> GpioResult {
...
//     pub fn get_pwm_duty_cycle(&self, user_gpio: u32) -> GpioResponse {
...
//     pub fn servo(&self, user_gpio: u32, pulse_width: u32) -> GpioResult {
...
//     pub fn get_servo_pulse_width(&self, user_gpio: u32) -> GpioResponse {
...
//     pub fn set_pwm_range(&self, user_gpio: u32, range: u32) -> GpioResponse {
...
//     pub fn get_pwm_range(&self, user_gpio: u32) -> GpioResponse {
...
//     pub fn get_pwm_real_range(&self, user_gpio: u32) -> GpioResponse {
...
//     pub fn set_pwm_frequency(&self, user_gpio: u32, frequency: u32) -> GpioResponse {
...
//     pub fn get_pwm_frequency(&self, user_gpio: u32) -> GpioResponse {
...
//     pub fn hardware_clock(&self, gpio: u32, frequency: u32) -> GpioResult {
...
//     /// ~~~
//     pub fn hardware_pwm(&self, gpio: u32, frequency: u32, dutycycle: u32) -> GpioResult {
