...
type GpioResult = Result<(), String>;
type GpioResponse = Result<i32, String>;
...
pub fn servo(user_gpio: u32, pulsewidth: u32) -> GpioResult {
...
pub fn get_servo_pulse_width(user_gpio: u32) -> GpioResult {
...
pub fn set_pwm_range(user_gpio: u32, range: u32) -> GpioResult {
...
pub fn set_pwm_frequency(user_gpio: u32, frequency: u32) -> GpioResult {
